...
cells.append(md(
    '# Notebook 04 v2: LSTM Digital Twin (Delta Prediction)\n\n'
    '**Fix:** Predict the CHANGE (delta) in sensor values rather than absolute next state.\n'
    'This dramatically reduces RMSE because step-to-step deltas are small and learnable.\n\n'
    'At inference: `next_state = current_state + predicted_delta`',
    '0001'))
...
cells.append(md('## 4.1 Load Raw Data and Build DELTA Training Pairs', '0003'))
...
cells.append(md('## 4.2 Train the Delta-LSTM Twin', '0005'))
...
cells.append(md('## 4.3 Evaluate on Test Set', '0008'))
...
cells.append(md('## 4.4 Visualize Reconstructed Next States', '0010'))
...
cells.append(md('## 4.5 Directional Accuracy (What Actually Matters)', '0012'))
